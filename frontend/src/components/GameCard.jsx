const TAG_COLORS = {
  blue: 'bg-blue-950/40 text-blue-400 border-blue-500/50',
  trending: 'bg-blue-950/40 text-blue-400 border-blue-500/50',
  live: 'bg-red-950/40 text-red-400 border-red-500/50',
  discount: 'bg-emerald-950/40 text-emerald-400 border-emerald-500/50',
  emerald: 'bg-emerald-950/40 text-emerald-400 border-emerald-500/50',
  new: 'bg-purple-950/40 text-purple-400 border-purple-500/50',
  violet: 'bg-purple-950/40 text-purple-400 border-purple-500/50',
  accent: 'bg-blue-950/40 text-blue-400 border-blue-500/50',
  cyan: 'bg-blue-950/40 text-blue-400 border-blue-500/50',
  amber: 'bg-amber-950/40 text-amber-400 border-amber-500/50',
}
