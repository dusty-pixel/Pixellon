      ...
      <div className="fixed inset-0 z-50 flex items-center justify-center p-4 sm:p-6 overflow-y-auto">
        ...
        >
          ...
          <div className="p-6 space-y-6 max-h-[75vh] overflow-y-auto">
            ...
            <div className="relative overflow-hidden rounded-3xl border border-surface-700 bg-brand-surface p-6 sm:p-8 shadow-2xl">
              ...
              <div className="rounded-xl border border-amber-500/30 bg-amber-500/5 p-4 space-y-3">
                ...
                <div className="flex items-center gap-4">
                  ...
                  <button
                    ...
                    className="mt-4 rounded-lg bg-brand-primary hover:bg-[#0274B3] px-4 py-2 text-xs font-mono font-bold text-white transition-colors cursor-pointer"
                  >
                    Save
                  </button>
                </div>
