      ...
      <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/80 backdrop-blur-sm overflow-y-auto">
        ...
        >
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            {/* Open to Play Toggle */}
            <div className="flex items-center justify-between rounded-lg border border-brand-primary/30 bg-brand-primary/10 p-3.5">
              <div className="space-y-0.5">
                ...
                <p className="text-[11px] text-brand-muted">
                  Displays the status ring showing teammates you're ready to squad up.
                </p>
              </div>
              <button
                type="button"
                ...
                className={`relative inline-flex h-6 w-11 shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-200 ease-in-out focus:outline-none ${
                  formData.openToPlay ? 'bg-brand-primary' : 'bg-surface-700'
                }`}
              >
                <span
            ...
            <div className="flex items-center justify-end gap-3 pt-4 border-t border-surface-700">
              <button
                type="button"
                onClick={onClose}
                className="rounded-lg border border-surface-700 bg-surface-900 px-4 py-2 text-xs font-semibold text-brand-muted hover:text-brand-text transition-all cursor-pointer"
              >
                Cancel
              </button>
              <button
