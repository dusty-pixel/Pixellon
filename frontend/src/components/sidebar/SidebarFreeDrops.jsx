  ...
  return (
    <div className="rounded-2xl border border-surface-700 bg-brand-surface p-5 shadow-xl transition-all hover:border-brand-primary/40">
      ...
      <div className="flex items-center justify-between border-b border-surface-700 pb-3 mb-4">
        ...
        <span className="badge-discount text-[10px] py-0.5 px-2">
          100% OFF
        </span>
      </div>
      ...
      <div className="relative overflow-hidden rounded-xl border border-surface-700 bg-surface-900 p-3.5">
        ...
        <div className="mt-3 pt-2.5 border-t border-surface-700 flex items-center justify-between text-xs font-mono">
          ...
          <div className="flex items-center gap-1 font-bold text-brand-accent text-xs">
            <span className="rounded bg-brand-surface px-1.5 py-0.5 border border-brand-primary/20">
      ...
      <Link
        to="/free-games"
        className="mt-3.5 flex w-full items-center justify-center gap-2 rounded-lg bg-brand-primary hover:bg-[#0274B3] py-2.5 text-xs font-bold text-white transition-all active:scale-95 cursor-pointer shadow-md"
      >
