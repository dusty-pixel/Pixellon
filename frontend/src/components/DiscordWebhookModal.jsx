          ...
          <div className="flex items-start gap-4 mb-6">
            ...
            <div>
              <h2 className="font-display text-xl font-bold text-brand-text flex items-center gap-2">
                Connect Discord Bot
                {isSaved && (
                  <span className="inline-flex items-center gap-1 rounded-md bg-emerald-500/20 px-2 py-0.5 text-[10px] font-mono text-emerald-400 border border-emerald-500/40">
          ...
          <div className="space-y-3 mb-6">
            ...
            <div className="relative">
              <input
                ...
                className="w-full rounded-lg border border-surface-700 bg-surface-900 py-3 pl-3.5 pr-10 text-xs font-mono text-brand-text placeholder:text-brand-muted/50 focus:border-[#5865F2] focus:outline-none focus:ring-1 focus:ring-[#5865F2] transition-all"
              />
              {webhookInput && (
                <button
                  type="button"
          ...
          <div className="flex flex-wrap items-center justify-between gap-3 pt-2 border-t border-surface-700">
            {isSaved && (
              <button
                type="button"
                onClick={handleClear}
                className="inline-flex items-center gap-1.5 rounded-lg border border-rose-500/30 bg-rose-500/10 px-3.5 py-2.5 text-xs font-mono font-medium text-rose-400 hover:bg-rose-500/20 transition-all cursor-pointer"
              >
            ...
            <div className="flex items-center gap-2 ml-auto">
              <button
                ...
                className="inline-flex items-center gap-2 rounded-lg border border-[#5865F2]/40 bg-[#5865F2]/20 px-4 py-2.5 text-xs font-mono font-medium text-[#7983f5] hover:bg-[#5865F2]/30 transition-all disabled:opacity-50 cursor-pointer"
              >
                {isTesting ? (
