              ...
              <div className="relative z-10 grid gap-8 lg:grid-cols-12 items-center">
                ...
                <div className="lg:col-span-7 space-y-5">
                  <div className="inline-flex items-center gap-2 rounded-lg border border-brand-primary/30 bg-brand-primary/10 px-3 py-1 text-xs font-mono font-semibold text-brand-accent tracking-wide">
                    ...
                    <span>GAMING DATABASE & RADAR</span>
                  </div>
                  ...
                  <p className="text-sm sm:text-base leading-relaxed text-brand-muted max-w-xl font-sans">
                    Track verified free giveaways, live esports tournaments, breaking game updates, and community codex guides all in one place.
                  </p>
                  ...
                  <div className="flex flex-wrap gap-3 pt-2">
                    <Link
                      to="/codex"
                      id="hero-cta-codex"
                      className="rounded-lg bg-brand-primary px-5 py-2.5 text-sm font-semibold text-white transition-all duration-150 hover:bg-brand-primary/90 active:scale-95 cursor-pointer font-sans shadow-sm"
                    >
                      Browse Game Codex →
                    </Link>
                    <Link
                      ...
                      className="rounded-lg border border-surface-700 bg-surface-900 px-5 py-2.5 text-sm font-semibold text-brand-text transition-all duration-150 hover:border-brand-accent/50 hover:bg-surface-800 cursor-pointer font-sans"
                    >
                      Free Games Vault
                    </Link>
                  </div>
                ...
                <div className="lg:col-span-5 flex justify-center">
                  <div className="relative w-full max-w-sm rounded-2xl border border-surface-700 bg-surface-900 p-6 shadow-md">
                    <div className="flex items-center justify-between border-b border-surface-700 pb-3 mb-5">
                      <div className="flex items-center gap-2">
                        <PixellonIcon size={18} />
                        <span className="font-mono text-xs font-semibold text-brand-text uppercase tracking-wider">
                          LIVE RADAR STATS
                        </span>
                      </div>
                      <span className="font-mono text-[10px] text-brand-accent bg-brand-primary/10 border border-brand-primary/20 px-2 py-0.5 rounded">ONLINE</span>
                    </div>

                    <div className="space-y-3 font-mono text-xs">
                      <div className="flex items-center justify-between p-2.5 rounded-lg bg-brand-surface border border-surface-700">
                        <span className="text-brand-muted">Catalog Games</span>
                        <span className="text-brand-text font-bold">1,840+ Titles</span>
                      </div>
                      <div className="flex items-center justify-between p-2.5 rounded-lg bg-brand-surface border border-surface-700">
                        <span className="text-brand-muted">Active Giveaways</span>
                        <span className="text-brand-accent font-bold">100% OFF Steam/Epic</span>
                      </div>
                      <div className="flex items-center justify-between p-2.5 rounded-lg bg-brand-surface border border-surface-700">
                        <span className="text-brand-muted">Tournament Feeds</span>
                        <span className="text-brand-accent font-bold">Real-Time Sync</span>
                      </div>
                    </div>

                    <div className="mt-4 pt-3 border-t border-surface-700 text-center">
                      <span className="text-[11px] font-mono text-brand-muted">Independent • Real-Time • No Paywalls</span>
                    </div>
                  </div>
                </div>
              </div>
