  ...
  return (
    <PageTransition>
      <div className="mx-auto max-w-[1600px] 2xl:max-w-[1720px] px-4 sm:px-6 lg:px-8 xl:px-10 py-6 sm:py-10 space-y-8">
        {/* Arena Header */}
        <header className="relative overflow-hidden rounded-3xl border border-surface-700 bg-gradient-to-br from-brand-surface via-surface-900 to-brand-bg p-6 sm:p-10 shadow-2xl">
          <PixelPatternBg />
          {/* Ambient Glows */}
                ...
                <motion.article
                  ...
                  className={`group relative flex flex-col overflow-hidden rounded-3xl border transition-all duration-300 hover:scale-[1.01] ${
                    isRunning
                      ...
                      : 'border-surface-700 hover:border-brand-primary/70 hover:shadow-[0_0_30px_rgba(37,99,235,0.25)]'
                  }`}
                  style={{
                    background: `
