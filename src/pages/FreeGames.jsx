            ...
            <div className="absolute top-0 left-0 right-0 h-1 bg-[#1A2234] z-20 overflow-hidden">
              {!isPaused && (
                <motion.div
                  ...
                  className="h-full bg-gradient-to-r from-brand-primary via-amber-400 to-emerald-400"
                />
              )}
            </div>
                  ...
                  <div className="flex flex-1 flex-col p-5 pt-4">
                    ...
                    <div className="mt-auto pt-2">
                      <a
                        ...
                        target="_blank"
                        rel="noopener noreferrer"
                        className={`group/btn relative flex w-full items-center justify-center gap-1.5 rounded-xl px-4 py-2.5 text-center text-xs font-semibold text-white transition-all duration-200 cursor-pointer ${
                          isGiveaway
                            ? 'bg-gradient-to-r from-amber-600 to-orange-600 hover:from-amber-500 hover:to-orange-500 shadow-[0_4px_14px_rgba(245,158,11,0.3)] hover:shadow-[0_6px_20px_rgba(245,158,11,0.45)]'
                            : 'bg-gradient-to-r from-brand-primary to-blue-600 hover:from-blue-500 hover:to-indigo-500 shadow-[0_4px_14px_rgba(37,99,235,0.3)] hover:shadow-[0_6px_20px_rgba(37,99,235,0.45)]'
                        }`}
                      >
