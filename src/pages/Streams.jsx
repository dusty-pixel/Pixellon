      ...
      <div className="mx-auto max-w-[1600px] 2xl:max-w-[1720px] px-4 sm:px-6 lg:px-8 xl:px-10 py-6 sm:py-10 space-y-8">
        ...
        <header className="relative overflow-hidden rounded-2xl border border-surface-700 bg-brand-surface p-6 sm:p-8">
          ...
          <div className="relative z-10 flex flex-col md:flex-row md:items-center md:justify-between gap-6">
            <div>
              <div className="mb-2.5 inline-flex items-center gap-2 rounded-full bg-red-950/40 border border-red-500/30 px-3 py-1 text-xs font-mono font-bold text-red-400">
                      ...
                      <div className="relative w-full h-full group">
                        ...
                        <div className="absolute inset-y-0 left-0 flex items-center pl-3">
                          <button
                            ...
                            className="flex h-10 w-10 items-center justify-center rounded-full bg-black/60 text-white backdrop-blur-md border border-white/10 transition-transform hover:scale-110 active:scale-95 cursor-pointer"
                        ...
                        <div className="absolute top-4 left-4 flex flex-wrap items-center gap-2">
                          <span className="flex items-center gap-1.5 rounded-full bg-red-600 px-3 py-1 text-xs font-mono font-bold text-white shadow-lg animate-pulse">
                            <span className="h-2 w-2 rounded-full bg-white" />
                            LIVE THEATER
                          </span>

                          {selectedStream.is24_7 && (
                            <span className="flex items-center gap-1 rounded-full bg-amber-500/20 text-amber-300 border border-amber-500/40 px-3 py-1 text-xs font-mono font-bold backdrop-blur-md shadow-md">
                          ...
                          {selectedStream.isOfficial && (
                            <span className="flex items-center gap-1 rounded-full bg-blue-500/20 text-blue-300 border border-blue-500/40 px-3 py-1 text-xs font-mono font-bold backdrop-blur-md shadow-md">
                          ...
                          <span
                            className={`rounded-full px-3 py-1 text-xs font-mono font-bold border backdrop-blur-md ${getGameBadgeColor(
                        ...
                        <div className="absolute inset-0 flex flex-col items-center justify-center gap-3">
                          <button
                            ...
                            className="group/btn flex items-center gap-3 rounded-2xl bg-brand-primary/95 px-6 py-3.5 text-base font-bold text-white shadow-[0_0_30px_rgba(37,99,235,0.6)] backdrop-blur-md transition-all hover:bg-brand-primary hover:scale-105 active:scale-95 cursor-pointer"
                          >
                            <Play className="h-6 w-6 fill-white ml-0.5" />
                            <span>Play Live Stream in Theater</span>
                          </button>
                          <span className="text-xs font-mono text-zinc-400 bg-black/60 px-3 py-1 rounded-full backdrop-blur-sm">
                        ...
                        <div className="absolute bottom-4 left-4 right-4 flex items-center justify-between">
                          <div className="flex items-center gap-3">
                            <div className="h-12 w-12 rounded-xl overflow-hidden border-2 border-brand-primary shadow-lg bg-zinc-800 shrink-0">
                              <img
                  ...
                  <div className="lg:col-span-4 p-6 sm:p-7 flex flex-col justify-between border-t lg:border-t-0 lg:border-l border-surface-700 bg-surface-900">
                    ...
                    <div className="space-y-2.5 pt-4 border-t border-surface-700 mt-4">
                      <a
                        ...
                        className="flex w-full items-center justify-center gap-2 rounded-xl bg-[#9146FF] px-4 py-2.5 text-sm font-bold text-white transition-all hover:bg-[#772CE8] shadow-[0_0_15px_rgba(145,70,255,0.3)] cursor-pointer"
                      >
                      ...
                      <button
                        ...
                        className="flex w-full items-center justify-center gap-2 rounded-xl border border-[#5865F2]/40 bg-[#5865F2]/15 px-4 py-2.5 text-sm font-bold text-[#7983F5] transition-all hover:bg-[#5865F2]/30 cursor-pointer"
                      >
            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 pt-4">
              ...
              <div className="flex items-center gap-2 overflow-x-auto pb-2 scrollbar-thin">
                ...
                >
                  ...
                  <span className="text-[10px] px-1.5 py-0.2 rounded-full bg-black/30 text-amber-200">
                    {streams247.length}
                  </span>
                </button>
                ...
                >
                  ...
                  <span className="text-[10px] px-1.5 py-0.2 rounded-full bg-blue-950/60 text-blue-200">
                  ...
                  >
                    ...
                    <div className="relative aspect-video overflow-hidden bg-black">
                      ...
                      <div className="absolute left-3 top-3 flex items-center gap-1.5">
                        {stream.is24_7 ? (
                          <div className="flex items-center gap-1 rounded-md bg-amber-500 px-2.5 py-0.5 text-[10px] font-mono font-bold text-black shadow-md">
                            <Zap className="h-3 w-3 fill-black" />
                            24/7 NON-STOP
                          </div>
                        ) : (
                          <div className="flex items-center gap-1.5 rounded-md bg-red-600 px-2.5 py-0.5 text-[10px] font-mono font-bold text-white shadow-md">
                        ...
                        {stream.isOfficial && (
                          <div className="flex items-center gap-1 rounded-md bg-blue-600 px-2 py-0.5 text-[10px] font-mono font-bold text-white shadow-md">
                      ...
                      {/* Viewers Counter */}
                      <div className="absolute top-3 right-3 flex items-center gap-1 rounded-md bg-black/75 backdrop-blur-md px-2 py-0.5 text-[11px] font-mono font-bold text-emerald-400 border border-white/10">
                      ...
                      <div className="absolute inset-0 flex items-center justify-center gap-3 bg-black/60 opacity-0 backdrop-blur-[2px] transition-opacity duration-300 group-hover:opacity-100">
                        <button
                          ...
                          className="flex items-center gap-2 rounded-xl bg-brand-primary px-3.5 py-2 text-xs font-bold text-white shadow-lg transition-transform hover:scale-105 cursor-pointer"
                        >
                        ...
                        <a
                          ...
                          target="_blank"
                          rel="noopener noreferrer"
                          className="flex items-center justify-center rounded-xl bg-[#9146FF] p-2 text-white shadow-lg transition-transform hover:scale-105 cursor-pointer"
                    ...
                    <div className="flex flex-1 flex-col p-4 sm:p-5">
                      ...
                      <div className="mb-2 flex items-center gap-2.5">
                        ...
                        <div className="flex flex-1 items-center justify-between min-w-0">
                          ...
                          <span
                            className={`truncate rounded-md px-2 py-0.5 text-[10px] font-mono border font-semibold ${getGameBadgeColor(
                              stream.game_name,
                              stream.isOfficial
                            )}`}
                          >
              ...
              <div className="relative z-10 flex flex-col md:flex-row md:items-center justify-between gap-6">
                ...
                <div className="flex flex-wrap items-center gap-3">
                  <button
                    ...
                    className="flex items-center gap-2 rounded-xl bg-[#5865F2] px-5 py-3 text-sm font-bold text-white shadow-lg transition-all hover:bg-[#4752C4] cursor-pointer"
                  >
                    <Send className="h-4 w-4" />
