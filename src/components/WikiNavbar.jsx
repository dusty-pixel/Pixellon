...
export default function WikiNavbar({ gameId, gameName, pages = {} }) {
  ...
  return (
    <div className="border-b border-surface-700 bg-brand-surface/95 backdrop-blur-md sticky top-[61px] z-40 shadow-sm w-full">
      <div className="w-full px-4 sm:px-8 lg:px-12">
        <div className="flex h-12 items-center gap-6 overflow-x-auto whitespace-nowrap scrollbar-none">
          ...
          <div className="h-4 w-px bg-surface-700 shrink-0"></div>
